  ...
  return html`
    <div class="list-page-head">
      <div>
        ...
        ${o.subtitle ? html`<div class="pane-subtitle">${t(o.subtitle)}</div>` : nothing}
      </div>
    ...
    ${o.filters ?? nothing}
    ${o.rows.length ? listRowsTpl(o.rows) : html`<div class="empty compact">${typeof o.empty === "string" ? t(o.empty) : o.empty}</div>`}
  `;
}
