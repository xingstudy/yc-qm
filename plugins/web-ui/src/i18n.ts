...
const ZH: Record<string, string> = {
  ...
  "Create a new Enterprise WeChat Bot": "创建新的企业微信机器人",
  ...
  "Could not authorize Enterprise WeChat bot.": "无法创建或绑定企业微信智能机器人。",
  "Enterprise WeChat authorization window was blocked.": "企业微信授权窗口被浏览器拦截，请允许弹窗后重试。",
