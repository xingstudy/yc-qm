...
for name in POSTGRES_PASSWORD CORE_SIGNING_SECRET CAPABILITY_SECRET PORTAL_IDENTITY_SECRET PORTAL_SESSION_SECRET CONNECTOR_SECRET_KEY WEB_UI_IM_CREDENTIALS_KEY SKILL_SIGNING_SECRET AUTH_TOKEN_SECRET; do
